  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evento as @evento" do
        ...
        post :create, {:evento => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:evento)).to be_a_new(Evento)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evento" do
        ...
        expect_any_instance_of(Evento).to receive(:update).with({ "titulo" => "MyString" })
        put :update, {:id => evento.to_param, :evento => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evento as @evento" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Evento.any_instance.stub(:save).and_return(false)
        put :update, {:id => evento.to_param, :evento => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:evento)).to eq(evento)
      end
