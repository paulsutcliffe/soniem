  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved audio as @audio" do
        ...
        post :create, {:audio => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:audio)).to be_a_new(Audio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested audio" do
        ...
        expect_any_instance_of(Audio).to receive(:update).with({ "titulo" => "MyString" })
        put :update, {:id => audio.to_param, :audio => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the audio as @audio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Audio.any_instance.stub(:save).and_return(false)
        put :update, {:id => audio.to_param, :audio => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:audio)).to eq(audio)
      end
